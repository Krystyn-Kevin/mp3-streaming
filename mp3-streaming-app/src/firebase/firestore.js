...
/** Removes a song document. Storage cleanup (audio/cover files) is handled
 * separately in firebase/storage.js since it needs the Storage SDK. */
export async function deleteSongDoc(songId) {
